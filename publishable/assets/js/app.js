...
var map,
    ...
    locations = [],
    infoWindow;
var $locationsMap = document.getElementById('locations-map');
var $locationMap = document.getElementById('location-single-map');
var $locationsList = document.querySelector('.locations-list');
var $listingFilters = document.querySelectorAll('.listing-filter');
var $locationsSearchBtn = document.querySelector('.locations-search-btn');
var $locationsLoader = document.getElementById('locations-loader');
var locationLabels = 'ABCDEFGHIJKLMNOPQRSTUVWXYZ';
var locationsLabelIndex = 0;
var position = false;
...
function createMarker(latlng, listing, label, i) {
  var directions = '<a class="get-directions-marker" href="https://maps.google.com?daddr=' + listing.street + ' ' + listing.city + ' ' + listing.state + ' ' + listing.postal + '" target="_blank">Get directions</a>';
  var html = '';
  ...
  var markerData = {
    ...
    label: {
      text: label,
      color: locationsSettings.pin_label_color
    }
  };
...
function createListItem(listing, label, i) {
  var html = '<li data-locations-item="' + i + '">';
  ...
  var $listItems = document.querySelectorAll('[data-locations-marker]');

  if ($listItems.length) {
    $listItems.forEach(function (v) {
      v.addEventListener('click', function (el) {
        el.preventDefault();
        var markerNum = el.target.getAttribute('data-locations-marker');
...
function filterLocations() {
  ...
  locations.forEach(function (v, i) {
    ...
    var label = locationLabels[locationsLabelIndex++ % locationLabels.length];
...
function loadLocationMarker() {
  var latlng = new google.maps.LatLng(parseFloat(singleLocation.lat), parseFloat(singleLocation.lng));
  var directions = '<a class="get-directions-marker" href="https://maps.google.com?daddr=' + singleLocation.street + ' ' + singleLocation.city + ' ' + singleLocation.state + ' ' + singleLocation.postal + '" target="_blank">Get directions</a>';
  var html = '';
...
__webpack_require__(/*! /Users/donjones/Sites/neutrino-test/vendor/newelement/locations/resources/assets/js/app.js */"./resources/assets/js/app.js");
module.exports = __webpack_require__(/*! /Users/donjones/Sites/neutrino-test/vendor/newelement/locations/resources/assets/sass/app.scss */"./resources/assets/sass/app.scss");
